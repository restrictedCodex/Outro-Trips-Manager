            ...
            <form onSubmit={submit} className='form black-container'>
                ...
                <label>
                    ...
                    <select ref={(input) => type=input}>
                        <option value='Trek' className='option-div'>Trek</option>
                        <option value='Tropic' className='option-div'>Tropic</option>
                        <option value='Club' className='option-div'>Club</option>
                    </select>
                </label>
